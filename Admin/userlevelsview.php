...
fuserlevelsview.lists["x_userlevelname"] = <?php echo $userlevels_view->userlevelname->Lookup->toClientList() ?>;
fuserlevelsview.lists["x_userlevelname"].options = <?php echo JsonEncode($userlevels_view->userlevelname->lookupOptions()) ?>;
fuserlevelsview.autoSuggests["x_userlevelname"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
