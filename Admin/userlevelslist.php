...
fuserlevelslist.lists["x_userlevelname"] = <?php echo $userlevels_list->userlevelname->Lookup->toClientList() ?>;
fuserlevelslist.lists["x_userlevelname"].options = <?php echo JsonEncode($userlevels_list->userlevelname->lookupOptions()) ?>;
fuserlevelslist.autoSuggests["x_userlevelname"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
