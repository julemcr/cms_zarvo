...
fuserlevelsdelete.lists["x_userlevelname"] = <?php echo $userlevels_delete->userlevelname->Lookup->toClientList() ?>;
fuserlevelsdelete.lists["x_userlevelname"].options = <?php echo JsonEncode($userlevels_delete->userlevelname->lookupOptions()) ?>;
fuserlevelsdelete.autoSuggests["x_userlevelname"] = <?php echo json_encode(["data" => "ajax=autosuggest"]) ?>;
