...
class paises extends DbTable
{
	...
	public function __construct()
	{
		...
		// Codigo
		$this->Codigo = new DbField('paises', 'paises', 'x_Codigo', 'Codigo', '`Codigo`', '`Codigo`', 200, -1, FALSE, '`Codigo`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Pais
		$this->Pais = new DbField('paises', 'paises', 'x_Pais', 'Pais', '`Pais`', '`Pais`', 200, -1, FALSE, '`Pais`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->Pais->Nullable = FALSE; // NOT NULL field
	...
	{
		return ($this->SqlOrderBy <> "") ? $this->SqlOrderBy : "`Pais` ASC";
	}
	...
	public function getModalCaption($pageName)
	{
		...
		elseif ($pageName == "paisesedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "paisesadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("paisesview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("paisesview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "paisesadd.php?" . $this->getUrlParm($parm);
		else
			$url = "paisesadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("paisesedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("paisesadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("paisesdelete.php", $this->getUrlParm());
	}
