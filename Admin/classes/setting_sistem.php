...
class setting_sistem
{
	...
	// Table name
	public $TableName = 'setting_sistem.php';

	// Page object name
	public $PageObjName = "setting_sistem";
	...
	public function __construct()
	{
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'setting_sistem.php');
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("custom", "setting_sistem", $url, "", "setting_sistem", TRUE);
		$this->Heading = $Language->TablePhrase("setting_sistem", "TblCaption"); 
	}
}
?>