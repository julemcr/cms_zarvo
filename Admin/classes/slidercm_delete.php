 ...
 * Page class
 */
class slidercm_delete extends slidercm
{
	...
	// Page object name
	public $PageObjName = "slidercm_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("slidercmlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("slidercmlist.php"); // Return to list
			}
		}
	}
