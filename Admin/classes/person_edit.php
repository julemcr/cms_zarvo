 ...
 * Page class
 */
class person_edit extends person
{
	...
	// Page object name
	public $PageObjName = "person_edit";
	...
	public function run()
	{
		...
		if (IsApi()) {
			...
			// Load key from Form
			if ($CurrentForm->hasValue("x_PersonID")) {
				$this->PersonID->setFormValue($CurrentForm->getValue("x_PersonID"));
			}
		} else {
	...
	protected function loadFormValues()
	{
		...
		if (!$this->PersonID->IsDetailKey)
			$this->PersonID->setFormValue($val);
