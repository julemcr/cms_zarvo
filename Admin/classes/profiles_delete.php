 ...
 * Page class
 */
class profiles_delete extends profiles
{
	...
	// Page object name
	public $PageObjName = "profiles_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("profileslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("profileslist.php"); // Return to list
			}
		}
	}
