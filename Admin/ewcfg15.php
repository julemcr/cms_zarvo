...
define(PROJECT_NAMESPACE . "PROJECT_NAME", "cmsweb"); // Project name
define(PROJECT_NAMESPACE . "CONFIG_FILE_FOLDER", PROJECT_NAME); // Config file name
define(PROJECT_NAMESPACE . "RANDOM_KEY", '11mlg9c6vvLr8gnf'); // Random key for encryption
define(PROJECT_NAMESPACE . "ENCRYPTION_KEY", ''); // Encryption key for data protection
define(PROJECT_NAMESPACE . "PROJECT_STYLESHEET_FILENAME", "phpcss/cmsweb.css"); // Project stylesheet file name
...
$PROJECT_ID = "{5ACD2586-5733-4EB1-9592-B819B3395C82}"; // Project ID (GUID)
$RELATED_PROJECT_ID = "";
...
$CONNECTIONS["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "12345678", "db" => "cms_zarvo", "qs" => "`", "qe" => "`");
...
define(PROJECT_NAMESPACE . "ADMIN_USER_NAME", "innovacionespj"); // Administrator user name
define(PROJECT_NAMESPACE . "ADMIN_PASSWORD", "root"); // Administrator password
...
define(PROJECT_NAMESPACE . "USER_TABLE", "`person`");
define(PROJECT_NAMESPACE . "USER_NAME_FILTER", "(`Username` = '%u')");
define(PROJECT_NAMESPACE . "USER_ID_FILTER", "(`PersonID` = %u)");
...
define(PROJECT_NAMESPACE . "USER_PROFILE_SESSION_TIMEOUT", 1);
...
define(PROJECT_NAMESPACE . "USER_PROFILE_RETRY_LOCKOUT", 2);
define(PROJECT_NAMESPACE . "USER_PROFILE_LAST_PASSWORD_CHANGED_DATE", "LastPasswordChangedDate");
define(PROJECT_NAMESPACE . "USER_PROFILE_PASSWORD_EXPIRE", 30);
...
define(PROJECT_NAMESPACE . "SMTP_SERVER_USERNAME", "mail.dominio.com"); // SMTP server user name
define(PROJECT_NAMESPACE . "SMTP_SERVER_PASSWORD", "mail.dominio.com"); // SMTP server password
define(PROJECT_NAMESPACE . "SENDER_EMAIL", "correo@gmail.com"); // Sender email address
define(PROJECT_NAMESPACE . "RECIPIENT_EMAIL", "correo@gmail.com"); // Recipient email address
define(PROJECT_NAMESPACE . "MAX_EMAIL_RECIPIENT", 3);
define(PROJECT_NAMESPACE . "MAX_EMAIL_SENT_COUNT", 10);
...
define(PROJECT_NAMESPACE . "UPLOAD_ALLOWED_FILE_EXT", "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,svg"); // Allowed file extensions
...
define(PROJECT_NAMESPACE . "EXPORT_ALL_TIME_LIMIT", 120000); // Export all records time limit
...
define(PROJECT_NAMESPACE . "LOOKUP_CACHE_COUNT", 300000);
